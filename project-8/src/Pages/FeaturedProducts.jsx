  ...
  return (
    <Container className="py-5">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          <h2 className="fw-bold text-dark">🎂 Featured Cakes</h2>
          <p className="text-muted mb-0">Delicious treats handpicked for you!</p>
        </div>
        <Button variant="info" onClick={toggleSortOrder}>
        ...
        {paginatedProducts.length === 0 ? (
          ...
          paginatedProducts.map((product) => (
            <Col key={product.id} md={6} lg={4} xl={3} className="mb-4">
              <Card className="shadow-sm h-100" style={{ border: 'none', borderRadius: '15px', overflow: 'hidden' }}>
                <Card.Img
                  variant="top"
                  src={product.image}
                ...
                <Card.Body style={{ padding: '16px' }}>
                  <Card.Title style={{ fontSize: '1.2rem', fontWeight: 'bold', color: '#e91e63' }}>
                    {product.name}
                  </Card.Title>
                  ...
                  <div className="d-flex justify-content-between align-items-center">
                    ...
                    <Button
                      ...
                      style={{ fontSize: '0.8rem', borderRadius: '20px', padding: '6px 14px', fontWeight: '600' }}
                    >
                      Add to Cart
                    </Button>
                  </div>
